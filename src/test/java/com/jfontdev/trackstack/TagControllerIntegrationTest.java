...
public class TagControllerIntegrationTest extends BaseIntegrationTest {
        ...
        /**
         * Verifies that creating a tag with a null name returns 400 Bad Request.
         */
        @Test
        void createTagWithNullNameReturns400() {
                given()
                                .contentType(ContentType.JSON)
                                .body(Map.of()) // No name provided
                                .when()
                                .post("/api/tags")
                                .then()
                                .statusCode(400)
        ...
        /**
         * Verifies that creating a tag with an empty name returns 400 Bad Request.
         */
        @Test
        void createTagWithEmptyNameReturns400() {
                given()
                                .contentType(ContentType.JSON)
                                .body(Map.of("name", "   "))
                                .when()
        ...
        /**
         * Verifies that full update (PUT) with a null name returns 400 Bad Request.
         */
        @Test
        void updateTagWithNullNameReturns400() {
                long tagId = createTag("ValidTag");
        ...
        /**
         * Verifies that full update (PUT) with an empty name returns 400 Bad Request.
         */
        @Test
        void updateTagWithEmptyNameReturns400() {
                long tagId = createTag("ValidTag");
        ...
        /**
         * Verifies that partial update (PATCH) with an empty name returns 400 Bad
         * Request.
         */
        @Test
        void patchTagWithEmptyNameReturns400() {
                long tagId = createTag("ValidTag");
